...
3. 真想照着图一步一步点，就看 [逐屏截图版第一次上手教程](docs/逐屏截图版第一次上手教程.zh-CN.md)
4. 再看 [离线签名器一页备忘](docs/离线签名器一页备忘.zh-CN.md) 或 [快速开始](docs/快速开始.zh-CN.md)
5. 下载前先看 [官方程序下载验真与校验](docs/官方程序下载验真与校验.zh-CN.md)
6. 真要重建正式版时，再看 [固定正式发布重建入口](docs/固定正式发布重建入口.zh-CN.md)
...
- [逐屏截图版第一次上手教程](docs/逐屏截图版第一次上手教程.zh-CN.md)
