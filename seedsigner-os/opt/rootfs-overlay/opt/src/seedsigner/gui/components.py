...
_UI_TEXT_EXACT_MAP = {
    ...
    "Failed": "失败",
    "Factory Reset Card": "恢复出厂",
    "Admin PIN Required": "需要管理员 PIN",
    "User PIN Required": "需要用户 PIN",
    "Insert Card": "请插卡",
    "Default PINs": "默认 PIN",
    "Admin PIN change failed": "管理员 PIN 修改失败",
    "User PIN change failed": "用户 PIN 修改失败",
    "PIN updated. Please remove and re-insert the card.": "PIN 已更新，请拔卡后重新插入。",
    "Generating key": "正在生成密钥",
    "Key generated on card": "已在卡上生成密钥",
    "Generate On-Card Key": "在卡上生成密钥",
    "Change Admin PIN": "更改管理员 PIN",
    "Change User PIN": "更改用户 PIN",
    "Current Admin PIN": "当前管理员 PIN",
    "Current User PIN": "当前用户 PIN",
    "New Admin PIN": "新管理员 PIN",
    "New User PIN": "新用户 PIN",
...
_UI_TEXT_SUBSTRING_REPLACEMENTS = [
    ...
    ("These tools load data from the microSD card and may expose loaded secrets.", "这些工具会从 microSD 卡读取数据，可能暴露已加载的敏感数据。"),
    ("These tools read from the microSD card and may leak loaded secrets.", "这些工具会从 microSD 卡读取数据，可能泄露已加载的敏感数据。"),
    ("These tools write data to the microSD card and may expose loaded secrets.", "这些工具会向 microSD 卡写入数据，可能暴露已加载的敏感数据。"),
    ...
    ("Remove and re-insert the smartcard, then press Continue.", "请拔出并重新插入智能卡，然后按继续。"),
    ("Card uses default PINs. You'll set new Admin and User PINs before import.", "卡片仍在使用默认 PIN。导入前需要先设置新的管理员 PIN 和用户 PIN。"),
    ("Key generated on card", "已在卡上生成密钥"),
    ("Generating key", "正在生成密钥"),
    ("May take a while", "这可能需要一点时间"),
    ("Genuine: Error", "真伪检查错误"),
    ("No card info", "没有卡片信息"),
]
...
class GUIConstants:
    ...
    BASE_LOCALE_FONTS = {
        ...
        SettingsConstants.LOCALE__JAPANESE: "NotoSansSC-Regular",
        SettingsConstants.LOCALE__KOREAN: "NotoSansSC-Regular",
    }
    ...
    FIXED_WIDTH_FONT_NAME_JP = "Inconsolata-Regular"
    FIXED_WIDTH_EMPHASIS_FONT_NAME_JP = "Inconsolata-SemiBold"
