...
def has_valid_checksum(words: Sequence[str], word_to_index: dict[str, int]) -> bool:
    """Backwards-compatible alias for checksum validation-only checks."""
    return validate_mnemonic(words, word_to_index)
