...
class Controller(Singleton):
    ...
    def configure_instance(cls):
        ...
        if os.environ.get("TP_ONLY_MODE") == "1":
            controller.screensaver_activation_ms = 10 * 365 * 24 * 60 * 60 * 1000
    ...
    def start(self, initial_destination: Destination = None, skip_startup_interstitials: bool = False) -> None:
        ...
        try:
            if initial_destination:
                ...
                next_destination = home_destination
            ...
            if (not tp_only_mode) and Settings.RUNTIME_PROFILE not in {"luckfox_22", "luckfox_40", "luckfox_pi", "desktop"}:
            ...
            while True:
                ...
                if next_destination.View_cls is None or (tp_only_mode and next_destination.View_cls == MainMenuView):
                    next_destination = home_destination

                if next_destination == home_destination or (not tp_only_mode and next_destination.View_cls == MainMenuView):
                ...
                if next_destination.skip_current_view:
                    ...
                    if self.back_stack:
                        ...
                        logger.warning("skip_current_view requested with empty back_stack")
