...
- [树莓派固件 Releases 页面](https://github.com/akg5188/tp-satochip-signer/releases)
...
- `tp-qr-relay-android-latest.apk`（按需构建，不默认保留在 `dist/` 快照）
...
- 做扫码中转签名
- 对应源码在 `app/`
- 默认通过 `bash scripts/build_tp_relay_apk.sh` 现编
